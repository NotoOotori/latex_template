...
\begin{propositionnoproof}[{{\parencite[4]{jacobson_basic_1989}}}]\label{prop:cardcartcor}
...
\begin{propositionnoproof}[{{\parencite[104, Theorem 18.1]{munkres_topology_2000}}}]\label{prop:continuousimageclosure}
...
\thref{thm:CayleyHamilton}的一种标准的证法是利用伴随矩阵\parencite[369, Exercise 6.9]{aluffi_algebra_2009}, 也可以利用可对角化矩阵是Zariski稠密的这一事实, 并利用首元的存在性最终转化到域的情况来证明\footfullcite{__trivia_2020}.
...
\begin{theorem}[{{\parencite[66, Proposition 3.6; 67, Corollary 3.7]{milne_algebraic_2017}}}]

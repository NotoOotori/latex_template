...
\begin{enumerate}
  \item 如果对于任意的图$K\colon\cat{J}\to\cat{C}$和$K$上的极限锥, 它在$F$的像都定义了复合图$FK\colon \cat{J}\to\cat{D}$上的极限锥, 那么称$F$\emph{保持}这些极限;

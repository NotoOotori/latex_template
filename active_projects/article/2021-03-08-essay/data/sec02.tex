...
\begin{proposition}[第三同构定理{{\tjucite[126, Theorem 2.12 (ii)]{hungerford_algebra_1974}}}]\label{prop:thirdisomorphism}
...
\begin{proposition}[{{\tjucite[8, Proposition 1.11]{atiyah_introduction_1969}}}]\label{prop:prime}\leavevmode
  \begin{enumerate}
...
\footnotetext{Zorn引理的叙述如下: 如果一个非空偏序集的每个全序子链都有上界, 那么这个偏序集存在极大元. 在\axiom{ZF}公理系统下Zorn引理与选择公理\axiom{AC}等价\tjucite[10, Theorem 2.2]{herrlich_axiom_2006}.}

\begin{theorem}[{{\tjucite[3, Theorem 1.3]{atiyah_introduction_1969}}}]\label{thm:maxideal}
...
\begin{proposition}[{{\tjucite[8, Exercise 12; 9, Exercise 13]{atiyah_introduction_1969}}}]\label{prop:idealop}
...
\begin{proposition}[{{\tjucite[9, Proposition 1.14]{atiyah_introduction_1969}}}]\label{prop:scheinnullstellensatz}
...
\begin{proposition}[{{\tjucite[10, Proposition 1.17]{atiyah_introduction_1969}}}]\label{prop:extencontrcorr}
...
\begin{proposition}[{{\tjucite[10, Proposition 1.17]{atiyah_introduction_1969}}}]\label{prop:extencontrop}
...
有自然同态$f\colon A\to S^{-1}A$将$x$映到$x{\divslash}1$, 注意$f$不一定是单射. 分式环有如下的\emph{泛性质}\tjucites[81, Theorem 11.3]{altman_term_2017}[37, Proposition 3.1]{atiyah_introduction_1969}, 给定环$A$, 乘法闭集$S$与之前定义的自然同态$f\colon A\to S^{-1}A$, 对于任意的环$B$以及将$S$中元素映到单位的环同态$\phi\colon A\to B$, 存在唯一的环同态$\psi\colon S^{-1}R\to B$使得$\psi f=\phi$成立, 并且满足该泛性质的环$S^{-1}A$在同构意义下唯一.
...
\begin{proposition}[{{\tjucite[41, Proposition 3.11]{atiyah_introduction_1969}}}]\label{prop:fracideal}
...
\begin{proposition}[{{\tjucite[43, Exercise 3]{atiyah_introduction_1969}}}]\label{prop:multilocalization}
...
\begin{proposition}[{{\tjucite[21, Proposition 2.4]{atiyah_introduction_1969}}}]\label{prop:fgmoduleendomorphism}
...
\begin{proposition}[{{\tjucite[28, Proposition 2.16]{atiyah_introduction_1969}}}]\label{prop:fgmodule}
...
\begin{proposition}[{{\tjucite[30]{atiyah_introduction_1969}}}]\label{prop:fgalgebra}
...
\begin{proposition}[{{\tjucite[59, Proposition 5.1]{atiyah_introduction_1969}}}]\label{prop:integraldependence}
...
\begin{proposition}[{{\tjucite[74, Proposition 6.1]{atiyah_introduction_1969}}}]\label{prop:chaincondition}
...
\begin{proposition}[{{\tjucite[75, Proposition 6.2]{atiyah_introduction_1969}}}]\label{prop:noethermodule}
...
\begin{proposition}[{{\tjucite[75, Proposition 6.3]{atiyah_introduction_1969}}}]\label{prop:noethermoduleexactsequence}
  设
...
\begin{proposition}[{{\tjucite[76, Proposition 6.5]{atiyah_introduction_1969}}}]\label{prop:fgmoduleovernoetherring}
...
\begin{proposition}[{{\tjucite[76, Proposition 6.6; 80, Proposition 7.3]{atiyah_introduction_1969}}}]\label{prop:noetherring2}
  设$A$为Noether环, 则
  \begin{enumerate}
...
\begin{theorem}[Hilbert基定理{{\tjucites[81, Theorem 7.5]{atiyah_introduction_1969}[201, Theorem 1]{zariski_commutative_1958}}}]\label{thm:hilbertbasis}
...
\begin{proposition}[{{\tjucite[50, Proposition 4.1; 51, Lemma 4.3]{atiyah_introduction_1969}}}]\label{prop:primary}\leavevmode
  \begin{enumerate}
...
\begin{theorem}[Lasker–Noether定理{{\tjucites[83, Theorem 7.13]{atiyah_introduction_1969}[209, Theorem 4]{zariski_commutative_1958}}}]\label{thm:laskernoether}
...
\begin{proposition}[{{\tjucite[51, Lemma 4.4]{atiyah_introduction_1969}}}]\label{prop:idealquotprimary}
...
\begin{theorem}[{{\tjucite[52, Theorem 4.5]{atiyah_introduction_1969}}}]\label{prop:primuniq1}
...
\begin{proposition}[{{\tjucite[52, Proposition 4.6]{atiyah_introduction_1969}}}]\label{prop:isolatedprime}
...
\begin{proposition}[{{\tjucite[53, Proposition 4.8; 54, Proposition 4.9]{atiyah_introduction_1969}}}]\label{prop:primlocal}设$S$为环$A$的乘法闭集, 考虑典范同态$A\to S^{-1}A$.
  \begin{enumerate}
...
\begin{theorem}[{{\tjucite[54, Corollary 4.11]{atiyah_introduction_1969}}}]
...
维数理论也是交换代数的重要话题, Atiyah-MacDonald\tjucite[116--126, Chapter 11]{atiyah_introduction_1969}一书中介绍了一般的Noether局部环的维数理论, 需要模论以及完备化等技术. 限于篇幅原因, 这一节我们仅介绍域的有限生成整环的维数理论. 这一部分维数理论与域论关系密切, 因此我们将先介绍域论中的维数理论, 即超越基与超越次数;% TODO: 环中重要的是素理想 介绍素理想的高度与深度 介绍其与环维数的关系

% 域论的记号 代数相关代数无关 域扩张 F(S)

回顾线性空间的维数理论, 我们定义了线性空间中线性相关与线性无关的概念, 从而引出了Hamel基的概念, 并证明了Hamel基的存在性\footnotemark 及其在基数意义下的唯一性\tjucite[44--46, Section 2.1]{ciarlet_linear_2013}. 我们将推广这个工作, 定义集合论意义下的相关关系, 并将其应用在域扩张中, 从而得到域扩张的超越基与超越次数.
...
\begin{proposition}[{{\tjucite[123, Lemma 1]{jacobson_basic_1989}}}]\label{prop:dependlemma}
...
\begin{theorem}[{{\tjucite[123, Theorem 3.12]{jacobson_basic_1989}}}]\label{thm:dependbase}
...
\begin{proposition}[{{\tjucite[515, Theorem 8.33]{jacobson_basic_1989}}}]\label{prop:algbdependcrit}
...
\begin{proposition}[{{\tjucite[516, Theorem 8.34]{jacobson_basic_1989}}}]\label{prop:algbdependcorr}
...
\begin{theorem}[{{\tjucite[516, Theorem 8.35]{jacobson_basic_1989}}}]\label{thm:tranbasis}
...
\begin{proposition}[{{\tjucite[91, Lemma]{zariski_commutative_1960}}}]\label{prop:heightoneideallemma}
...
\begin{theorem}[{{\tjucite[193, Theorem 20]{zariski_commutative_1960}}}]\label{thm:ringdim}
...
\begin{proposition}[{{\tjucite[195, Corollary 3]{zariski_commutative_1960}}}]\label{prop:ringdimprimeidealexist}
...
\begin{theorem}[弱Hilbert零点定理{{\tjucite[82, Proposition 7.9]{atiyah_introduction_1969}}}]\label{thm:hilbert-nullstellensatz-weak}

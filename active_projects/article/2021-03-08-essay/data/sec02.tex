...
这一部分将以域的有限生成整环为原型, 发展本文中所需要用到的代数基础. 第一节中我们将研究一般的交换幺环的基础理论, 包括素理想, 极大理想, 整环等基础概念, 以及商环, 分式环之类的基础的技术, 我们将证明环与其商环或分式环之间都存在某种理想之间的对应关系, 并将证明商环与分式环可交换, 以及累次分式环与做一次分式环是等价的. 在第一节的最后我们将简要提及齐次环与齐次理想的概念, 为了射影簇等概念做准备.

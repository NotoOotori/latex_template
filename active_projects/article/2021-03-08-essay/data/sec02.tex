...
这一部分将以域的有限生成整环为原型, 发展本文中所需要用到的代数基础. 第一节中我们研究了一般的交换幺环的基础理论, 包括素理想, 极大理想, 整环等基础概念, 以及商环, 分式环之类的基础的技术, 我们证明了环与其商环或分式环之间都存在某种理想之间的对应关系, 并证明了商环与分式环可交换, 以及累次分式环与做一次分式环是等价的. 在第一节的最后我们简要提及了齐次环与齐次理想的概念, 为了射影簇等概念做准备.

第二节中我们首先引入了模的概念以及技术, 研究了有限生成模的性质并介绍了整元的概念. 接着我们讨论了模的升链条件, 并重点研究Noether环的性质, 先证明了Hilbert基定理, 即域的有限生成整环都是Noether环, 还证明了Lasker-Noether定理, 即Noether环的理想存在准素分解, 最后证明了一般的环上的准素分解都满足伴随素理想以及孤立准素理想的唯一性.

第三节中我们对域的有限生成整环的维数理论展开研究. 首先我们讨论了域扩张的超越基与超越次数, 将代数元的概念抽象为了集合中的对应关系, 并在抽象的情况下证明了基的基数是唯一的. 接着我们定义域的有限生成整环的维数即为其分式域关于基域的域扩张的超越次数, 并定义素理想的高度及深度, 利用域扩张的理论和Noether正规化引理证明了素理想的高度深度与域的有限生成整环的维数之间的关系, 并用此证明了Hilbert零点定理.

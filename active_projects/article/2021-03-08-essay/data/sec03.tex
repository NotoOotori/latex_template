...
之前我们定义了仿射代数簇和射影代数簇, 给出了其上的Zariski拓扑的结构. 事实上, 代数簇上面还有更精细的结构, 我们将在这一节中给出.
...
我们可以定义一些由函数构成的代数结构.% TODO: function field
...
\thref{prop:projspaceopencoverhomeo}\thref{prop:projvarietyopencoverhomeo}中的映射实际上是同构.% TODO: prop

...
A \emph{projective resolution} of a module $M$ is a long exact sequence,
\begin{equation*}
  \begin{tikzcd}[sep=small]
...
Usually, projective resolutions are easier to compute, while injective resolutions occur more naturally.

...
\begin{document}
    ...
    \begin{solution}
        ...
        \lstinputlisting[
            caption=fix\_point\_iteration.m,
            style=MATLAB-editor,
            basicstyle=\mlttfamily\scriptsize
        ]{fix_point_iteration.m}

        最终解得\matlabinline{x=1.3862}, \matlabinline{iter=22}.
    \end{solution}
    ...
    \begin{solution}
        ...
        解得迭代次数分别为\matlabinline{30}, \matlabinline{4}和\matlabinline{4}.
    \end{solution}
    ...
    \begin{solution}
        ...
        解得迭代次数分别为\matlabinline{5}, \matlabinline{25}和\matlabinline{9}.
    \end{solution}
    ...
    \begin{solution}
        ...
        \lstinputlisting[
            caption=modified\_newton\_iteration.m,
            style=MATLAB-editor,
            basicstyle=\mlttfamily\scriptsize
        ]{modified_newton_iteration.m}

        解得解和迭代次数分别为
        \matlabinline{-0.447214} \matlabinline{5},
        \matlabinline{43.720676} \matlabinline{14},
        \matlabinline{0.447214} \matlabinline{2}和
        \matlabinline{0.447214} \matlabinline{2}.
    \end{solution}

...
\begin{document}
    ...
    \lstinputlisting[
        caption=ode\_improved\_euler.m,
        style=MATLAB-editor,
        basicstyle=\mlttfamily\scriptsize
    ]{ode_improved_euler.m}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{na16_1.png}
        \caption{显格式与隐格式}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{na16_2.png}
        \caption{刚性问题}
    \end{figure}

    我们发现步长为0.25时Runge-Kutta方法发散了, 这是因为刚性方程组算法的稳定性必须要将步长限制在较小的范围内. 而0.2和0.25恰好过了步长的临界点.
